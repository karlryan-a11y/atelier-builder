...
-- Creates all new tables per the Atelier Builder spec
-- Run against existing Supabase that already has closet_items + clients tables

-- Enable pgvector if not already enabled (needed for Phase 5)
create extension if not exists vector;

-- ============================================================
-- Canonicalized tag system (replaces messy GoodPix flat tags)
-- ============================================================
...
-- Junction: which looks contain which closet items
...
-- Which stylists work with which clients
...
-- ============================================================
-- Vector embeddings on closet items (for AI matching)
-- ============================================================
